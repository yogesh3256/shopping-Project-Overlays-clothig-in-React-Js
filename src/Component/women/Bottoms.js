              ...
              return (
                <div key={bottomsitem.id}>
                  ...
                  <div className='grid grid-cols-3 md:grid-cols-6 gap-2'>
                    <button onClick={() => { navigate('Product', { state: bottomsarr[index] }) }} className='border border-black md:p-1 hover:bg-gray-200'>XS</button>
                    <button onClick={() => { navigate('Product', { state: bottomsarr[index] }) }} className='border border-black md:p-1 hover:bg-gray-200'>S</button>
                    <button onClick={() => { navigate('Product', { state: bottomsarr[index] }) }} className='border border-black md:p-1 hover:bg-gray-200 '>M</button>
                    <button onClick={() => { navigate('Product', { state: bottomsarr[index] }) }} className='border border-black md:p-1 hover:bg-gray-200 '>L</button>
                    <button onClick={() => { navigate('Product', { state: bottomsarr[index] }) }} className='border border-black md:p-1 hover:bg-gray-200 '>XL</button>
                    <button onClick={() => { navigate('Product', { state: bottomsarr[index] }) }} className='border border-black md:p-1 hover:bg-gray-200'>XXL</button>
                  </div>
